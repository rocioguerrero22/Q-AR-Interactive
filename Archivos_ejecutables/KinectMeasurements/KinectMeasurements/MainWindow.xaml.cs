                ...
                if (frame != null)
                {
                    ...
                    foreach (var skeleton in allSkeletons)
                    {
                        ...
                        if (skeleton.TrackingState == SkeletonTrackingState.Tracked)
                        {
                            ...
                            do
                            {
                                if (((skeleton.Joints[JointType.HipCenter].Position.Z * 100) > 130) && ((skeleton.Joints[JointType.HipCenter].Position.Z * 100) < 270))
                                {
                                    Instruccion.Text = ("Correcto!!! :)");
                                    break;
                                }

                                else if ((skeleton.Joints[JointType.HipCenter].Position.Z * 100) <= at)
                                {
                                    Instruccion.Text = ("Atras");
                                    break;
                                }
                                else if ((skeleton.Joints[JointType.HipCenter].Position.Z * 100) >= ad)
                                {
                                    Instruccion.Text = ("Adelante");
                                    break;
                                }
                            } while (null != this.sensor);

                            do
                            {
                                if (((skeleton.Joints[JointType.HipCenter].Position.X * 100)>-50) && ((skeleton.Joints[JointType.HipCenter].Position.X * 100)<60))
                            {
                                lado.Text = ("Correcto!!! :)");
                                break;
                            }

                            else if ((skeleton.Joints[JointType.HipCenter].Position.X * 100) <= iz)
                            {
                                lado.Text = ("derecha");
                                break;
                            }
                            else if ((skeleton.Joints[JointType.HipCenter].Position.X * 100) >= de)
                            {
                                lado.Text = ("izquierda");
                                break;
                            }
